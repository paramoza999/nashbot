...
: ${AMENT_CURRENT_PREFIX:="/home/param/nash_ws/src/nashbot/install/nashbot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nashbot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nashbot/environment/path.sh"
